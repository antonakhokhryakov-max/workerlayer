...
- **Host (compute):** the Mac mini. Lasting production value is `WORKERLAYER_HOST_URL=https://khokhryakov.net` (named Cloudflare tunnel → Mac mini `:43147`).
...
```
WORKERLAYER_HOST_URL=https://khokhryakov.net
```
